# CLAUDE.md — MeasureX Build Instructions
...
- **Scans are synchronous and sequential:** No job queue, no QStash, no Redis, no async workers. One prompt at a time, one engine at a time, in a for-loop. This is intentional.
